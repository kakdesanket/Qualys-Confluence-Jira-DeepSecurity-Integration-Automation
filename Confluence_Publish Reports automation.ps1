...
Set-ConfluenceInfo -BaseURI 'https://confluence.client.com' -PromptCredentials
$Page1=Get-ConfluencePage -PageID 11111111
Write-Host "Fetching Information from Confluence for page" $Page1 -ForegroundColor Green
Write-Host "Current Data on Page :"
$Page1.Body
$Database="C:\Users\Desktop\Qualys.db"
...
Set-ConfluencePage -PageID 11111111 -Body $NormalizeData1
...
$Page2=Get-ConfluencePage -PageID 11111111
...
Set-ConfluencePage -PageID 11111111 -Body $NormalizeData2
Write-Host "Updated Data on Page :"
$Page2.Body
...
$Page3=Get-ConfluencePage -PageID 11111111
...
Set-ConfluencePage -PageID 11111111 -Body $NormalizeData3
Write-Host "Updated Data on Page :"
$Page3.Body
...
$Page4=Get-ConfluencePage -PageID 11111111
Write-Host "Fetching Information from Confluence for page" $Page3 -ForegroundColor Green
Write-Host "Current Data on Page :"
$Page4.Body
Write-Host "Connecting to Confluence " -ForegroundColor Red
...
Set-ConfluencePage -PageID 11111111 -Body $NormalizeData4
Write-Host "Updated Data on Page :"
$Page4.Body
Write-Host "####End Confluence Page Distinct Vulnerability Database ###" -ForegroundColor Red
####End Confluence Page Distinct Vulnerability Database ###
